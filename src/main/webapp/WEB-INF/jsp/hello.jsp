...
<header id="header" class="alt">
    ...
    <nav id="nav">
        <ul>
            ...
            <li style="display:inline"><a href="#">Professors</a></li>
            <li style="display:inline;margin-right:43%"><a href="#">Categories</a></li>
        </ul>
    </nav>
</header>
<!-- Banner -->
<section id="banner">
    <div class="inner">
        ...
        <footer>
            <a href="#" class="button">Preview our professors</a>
        </footer>
    </div>
</section>
